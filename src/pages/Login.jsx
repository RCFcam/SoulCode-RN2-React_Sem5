            ...
            <form className="form-section" onSubmit={handleSubmit(entrar)}>
                ...
                <div>
                    ...
                    <input 
                        ...
                        {...register("email", { required: {value: 6, message: "O email é inválido!" }, })}
                        />
                ...
                <div>
                    ...
                    <input 
                        ...
                        id="senha" 
                        className="form-control"
                        {...register("senha", {required:"A senha é obrigatória", minLength: {value: 6, message: "Minimo de 6 caracteres!" }, })}
                        />
